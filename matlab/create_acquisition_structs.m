...
% datastruct_007 on retinotopyFinalMask)
...
% datastruct_001 : use AVG ROI MAP (from retinotopy runs), then select
% using blob_detector (python); blobType = 'difference' 
% datastruct_002 :  use AVG ROI MAP (from averaged retinotopy runs) to seed
% 3DCNMF.
...
didx = 2;           % Define datastruct analysis no.
