...
classif_identifier = 'stat_allrois_LinearSVC_kfold_3morphlevel_all_meanstim'
...
# Select TESTING data:
# #############################################################################
test_runid = 'blobs_dynamic_run1' #'blobs_dynamic_run6' #'blobs_dynamic_run1' #'blobs_dynamic_run1'
test_traceid = 'traces001'
test_data_type = 'smoothed_X' #'smoothedDF'
