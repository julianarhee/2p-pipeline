...
def extract_options(options):
    ...
    # PATH opts:
    parser.add_option('-T', '--sipath', action='store', dest='path_to_si_base', default='~/Downloads/ScanImageTiffReader-1.1-Linux', help='path to dir containing ScanImageTiffReader.py [default: ~/Downloads/ScanImageTiffReader-1.1.-Linux]')
