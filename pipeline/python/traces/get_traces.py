...
def extract_options(options):
    ...
    parser.add_option('--np-method', type='choice', choices=choices_npmethod, action='store', dest='np_method', default=default_npmethod, help="Method for neuropil correction. Valid choices: %s [default: %s]" % (choices_npmethod, default_npmethod))
