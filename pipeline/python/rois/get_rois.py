...
def standardize_rois(session_dir, roi_id, auto=False, zproj_type='mean', coreg_results_path=None, keep_good_rois=True, rootdir='', animalid='', session=''):
...
#
    ...
    if format_roi_output is True:
        mask_filepath = standardize_rois(session_dir, roi_id, auto=auto,
                                         check_motion=check_motion, zproj_type=zproj_type, mcmetric=mcmetric,
                                         coreg_results_path=coreg_results_path,
                                         rootdir=rootdir, animalid=animalid, session=session)
