        ...
        for bidx,boundary in enumerate(bounds):
            ...
            while start_idx < len(trigg_evs)-1: 
                ...
                try:
                    ...
                    print "Got to STOP."
                trigg_times.append([trigg_evs[start_idx:][curr_idx], stop_ev])
...
for cidx,condition in enumerate(POS.keys()):
    pydict[condition] ={'time': [i[0] for i in POS[condition].times], 'pos': POS[condition].vals, 'idxs': POS[condition].idxs}
