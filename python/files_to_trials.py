...
avg_img_fn = slice_fns[curr_slice_idx]
avg_tiff_path = os.path.join(curr_slice_dir, avg_img_fn)
...
plt.imshow(skimage.color.label2rgb(label_masks, image=imgnorm, alpha=0.1, colors=colorvals[1:]*255., bg_label=0))
plt.axis('off')
